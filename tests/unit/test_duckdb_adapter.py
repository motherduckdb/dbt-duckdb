...
class TestDuckDBAdapter(unittest.TestCase):
    ...
    def test_motherduck_postgres_endpoint(self):
        self.assertFalse(self.adapter.motherduck_postgres_endpoint())
        ...
        self.assertTrue(adapter.motherduck_postgres_endpoint())
